...
AFPSCharacter::AFPSCharacter()
{
	...
	// Create a mesh component that will be used when being viewed from a '1st person' view (when controlling this pawn),it's arm acutually
...
void AFPSCharacter::GetLifetimeReplicatedProps(TArray< FLifetimeProperty > & OutLifetimeProps) const
{
	...
	//for optimization use DOREPLIFETIME_CONDITION(AFPSCharacter, bIsCarryingObjective, COND_OwnerOnly);
}